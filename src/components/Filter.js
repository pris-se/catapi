...
export default function Filter({ breeds, getData }) {
  ...
  const breedOption = breeds.map((breed) => (
    ...
    <form className="filter" onSubmit={(e) => submitHandler(e)}>
      <div className="filter__row">
        <div className="filter__block">
          ...
          <select className="filter__select" value={filter.order} onChange={(e) => setFilter({ ...filter, order: e.target.value })}>
            {orderOption}
          </select>
        </div>
        <div className="filter__block">
          <h4 className="filter__name">ORDER</h4>
          <select className="filter__select" value={filter.mime_types} onChange={(e) => setFilter({ ...filter, mime_types: e.target.value })}>
      ...
      <div className="filter__row">
        ...
        <div className="filter__block">
          ...
          <div className="filter__subrow">
            <select className="filter__select" value={filter.limit} onChange={(e) => setFilter({ ...filter, limit: e.target.value })}>
              {limitOption}
            </select>
